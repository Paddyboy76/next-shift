...
def review_coverage(
    *,
    ...
    """Return the critic's durable review without mutating intake proposals.

    Operations owns bounded arbitration and must apply it exactly once. Keeping
    this adapter side-effect free prevents proposal indexes from shifting before
    the authoritative dispatch/hold decision is made.
    """
