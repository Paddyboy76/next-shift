...
root_agent = Agent(
    ...
    instruction=(
        ...
        "and next action are clear enough.\n\n"
        ...
        "from the handover, including ordinary human descriptions such as "
        "meeting room on the 7th floor or kitchen on the 8th floor. Do not "
        "invent a room number or asset identifier that was not stated.\n\n"
