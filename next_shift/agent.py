...
root_agent = Agent(
    ...
    instruction=(
        ...
        "that are actually known from the handover. Useful fields include:\n"
        "- LanguageAccess: language, service_location, requested_time\n"
        "- AssetLogistics: asset_type, destination, location\n"
        ...
        "For a leaking sink use facility_type=plumbing. For broken air "
        "conditioning use facility_type=air_conditioning.\n\n"
